  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/">
          <div onClick={() => scrollToSection("hero")} className="text-xl font-bold text-blue-600">Try-Catch-Mijo</div>
        </Link>
        ...
        <div className="space-x-2">
          ...
          <Link to="/register">
            <button className="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-800 transition">Registrarse</button>
          </Link>
        </div>
      </div>
    </nav>
